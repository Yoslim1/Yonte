...
- **الحد الأقصى المرجعي لملف الشاشة نفسها: 150 سطر.** لو عدّى، ده إشارة إن الشاشة بتعمل حاجتين (مثلاً "عرض + بحث" → يتفصلوا) — **إلا لو الملف لسه فيه composable top-level واحد بس وباقي الأجزاء متفوّضة فعليًا لملفاتها (orchestration screen طبيعي زي Scaffold مع Drawer+List+BottomSheet)، في الحالة دي تجاوز الحد مقبول** (مثال حقيقي: `NotesHomeScreen.kt`، 214 سطر، اتراجع واتقبل في commit `3403548`).
